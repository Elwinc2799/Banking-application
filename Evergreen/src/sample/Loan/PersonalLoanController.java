...
public class PersonalLoanController {
    ...
    void generatePFormPushed() {
        Font formTitle = FontFactory.getFont(FontFactory.TIMES_ROMAN, 25, Font.BOLD);
        Font title = FontFactory.getFont(FontFactory.TIMES_ROMAN, 20, Font.BOLD);
        Font content = FontFactory.getFont(FontFactory.TIMES_ROMAN, 14, Font.NORMAL);
